...
export const UPDATE_PRIVATE_COUNT_FROM_LIST = "UPDATE_PRIVATE_COUNT_FROM_LIST";
export const SET_IP = "SET_IP";
export const CLEAR_POSTS = "CLEAR_POSTS";
export const ADD_LOADING = "ADD_LOADING";
export const REMOVE_LOADING = "REMOVE_LOADING";
export const SET_FOLLOWING_FEED = "SET_FOLLOWING_FEED";
export const APPEND_FOLLOWING_FEED = "APPEND_FOLLOWING_FEED";
export const SET_TOPICS_FEED = "SET_TOPICS_FEED";
export const APPEND_TOPICS_FEED = "APPEND_TOPICS_FEED";
export const SET_NOT_LOGGED_IN_FEED = "SET_NOT_LOGGED_IN_FEED";
export const APPEND_NOT_LOGGED_IN_FEED = "APPEND_NOT_LOGGED_IN_FEED";
