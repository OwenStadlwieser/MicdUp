...
RCT_EXPORT_METHOD(applyFilter: (nonnull NSString *)name reverbPreset: (nonnull NSNumber*)reverbPreset rever: (nonnull NSNumber*)rever preGainDis: (nonnull NSNumber*)preGainDis distPreset: (nonnull NSNumber*)distPreset pitchNum: (nonnull NSNumber*)pitchNum dist: (nonnull NSNumber*)dist filter: (nonnull NSNumber*)filter callback:(RCTResponseSenderBlock)callback){
